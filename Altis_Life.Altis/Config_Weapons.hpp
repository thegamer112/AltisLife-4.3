...
class WeaponShops {
    ...
    class genstore {
        ...
        items[] = {
			...
			{ "NVGoggles", "", 2000 },
			{ "ItemGPS", "", 100 },
         { "tf_rf7800str", "Walkie Talkie, 2km", 180, 60},
         { "tf_anprc154", "Walkie-Talkie, 2km", 180, 60},
         { "tf_pnr1000a", "Walkie-Talkie, 2km", 180, 60},
         { "tf_anprc152", "Short-Range, 5km", 250, 125},
         { "tf_anprc148jem", "Short-Range, 5km", 250, 125},
         { "tf_fadak", "Short-Range", 250, 125},
			{ "ToolKit", "", 250 },
			//{ "FirstAidKit", "", 150 },
			{ "Chemlight_red", "", 300 },
